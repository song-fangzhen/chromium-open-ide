...
- For [Google Git](https://chromium.googlesource.com):
    ...
    <img src="images/COI03.png" onerror="this.onerror=null; this.remove();" alt="COI02.png" width="500"/>
    
    *Tips: Before using, we should check that have started listening from `VSCode`.*

    <img src="images/COI04.png" onerror="this.onerror=null; this.remove();" alt="COI03.png" width="500"/>
